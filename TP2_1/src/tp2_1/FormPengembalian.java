...
public class FormPengembalian extends javax.swing.JFrame {
    ...
    public FormPengembalian() {
        initComponents();
        kProses.koneksi();
        IsiTable();//agar tabel terisi saat form di load
    }
    ...
    private void initComponents() {
        ...
        Btn_Pengembalian.setBackground(new java.awt.Color(216, 156, 246));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(T_KodeBuku, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel2.setText("Afif Alfauzan-1801527");
    ...
    private void Btn_PengembalianActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_PengembalianActionPerformed
        ...
        if(kProses.cekkode(kode_buku)==1){//pengecekan kesamaan kode buku
            kProses.HapusData(kode_buku);
            IsiTable();
            T_KodeBuku.setText("");
        }else{
    ...
    public void IsiTable(){//mengisi data dari database ke tabel
